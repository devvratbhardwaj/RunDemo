...
# THIS IS NOT EVEN BEING CALLED ANYWHERE. ALTHOUGH TS DOCUMENT LOADER WILL HANDLE SPLITTING HTML TEXT
...
def execute():
    openai_api_key = st.secrets.openai_key  #DONE

    openai.api_key = openai_api_key         #DONE
